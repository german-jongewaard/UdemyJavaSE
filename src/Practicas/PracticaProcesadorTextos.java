...
class LaminaProcesadorTextos extends  JPanel{
    ...
    public void configuraMenu(String rotulo, String menu, String tipoLetra, 
         ...
         if(menu == "fuente"){ 
             ...
             else   elemMenuItem.addActionListener(new StyledEditorKit.ItalicAction());
         
         }else if(menu == "tamaño"){ 
             
             tamanio.add(elemMenuItem);
             
             elemMenuItem.addActionListener(new StyledEditorKit.FontSizeAction("cambiaLetra", tamanios));
         }
